...
const GfgIcon = () => (
  <svg role="img" viewBox="0 0 24 24" fill="#2f8d46" className="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div key={colIndex} className="grid grid-rows-7 gap-[3px]">
                      {Array.from({ length: 7 }).map((_, rowIndex) => {
                        ...
                        return (
                          <div
                            key={day.date}
                            className="aspect-square rounded-[3px] transition-all duration-150 hover:scale-110 cursor-pointer"
                            style={{
                              backgroundColor: color,
                              boxShadow: level > 0 ? `0 0 2.5px ${color}60` : "none",
                            }}
