  ...
  return (
    <>
      <button
        ...
        onClick={handleClick}
        id="mobile-fab"
        className="fixed bottom-6 right-4 md:bottom-8 md:right-8 z-40 w-14 h-14 rounded-full bg-[#0c0d12]/80 backdrop-blur-md border border-white/10 text-white shadow-[0_4px_25px_rgba(0,0,0,0.5)] hover:shadow-[0_0_25px_rgba(99,102,241,0.45)] hover:border-white/20 transform transition-all duration-300 overflow-hidden p-0 group flex items-center justify-center"
        style={{
        ...
        <div className="w-full h-full flex items-center justify-center relative">
          ...
          <div className="w-9 h-9 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 relative z-10">
            <svg className="w-full h-full animate-[pulse_2.2s_ease-in-out_infinite]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <radialGradient id="fabOrbGrad" cx="50%" cy="50%" r="50%">
                  <stop offset="0%" stopColor="#c084fc" stopOpacity="1" />
                  <stop offset="60%" stopColor="#6366f1" stopOpacity="0.85" />
                  <stop offset="100%" stopColor="#06b6d4" stopOpacity="0" />
                </radialGradient>
              </defs>
              <circle cx="12" cy="12" r="10" fill="url(#fabOrbGrad)" />
