        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <nav className="space-y-2">
              ...
              <a href="#coding" className="block text-gray-400 hover:text-white transition-colors">Coding</a>
              <a href="#contact" className="block text-gray-400 hover:text-white transition-colors">Contact</a>
              <a href="#faq" className="block text-gray-400 hover:text-white transition-colors">FAQs</a>
            </nav>
          </div>

          {/* Right Column - CTA glass */}
        ...
        <div className="pt-8 border-t border-white/10">
          ...
          <div className="mt-6 hidden sm:flex justify-center">
            <div className="inline-flex items-center gap-2 text-xs text-gray-400 bg-white/5 px-4 py-2 rounded-full border border-white/10">
              <span>Press</span>
              <kbd className="px-2 py-1 text-xs font-semibold bg-white/10 border border-white/20 rounded text-white font-mono">
                Ctrl+K
              </kbd>
              <span>to open the AI chatbot</span>
            </div>
          </div>
        </div>
      </div>
