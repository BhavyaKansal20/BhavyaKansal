          ...
          <div className={`space-y-10 ${contactVisible ? "scroll-animate scroll-animate-delay-1" : "opacity-0"}`}>
            ...
            <div className="space-y-4">
              {contactItems.map((item) => {
                const Inner = (
                  <div className="stat-tile flex items-start gap-4 p-4 rounded-2xl bg-white/14 dark:bg-white/8 backdrop-blur-2xl border border-white/10 hover:bg-white/18 dark:hover:bg-white/12 transition-all">
                    <div className="w-11 h-11 rounded-xl bg-white/70 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-sm border border-white/10 flex-shrink-0">
                      {item.icon}
                    </div>
              ...
              <div className="flex gap-3">
                {socials.map((s) => (
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-white/10 dark:bg-white/6 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all text-sm font-medium"
                  >
                    {s.icon}
                    {s.label}
                  </a>
